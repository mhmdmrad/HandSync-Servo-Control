...
it.start()
time.sleep(1)  # Allow time for Arduino communication to establish
...
while cap.isOpened():
    ...
    angle1 = 90  # Default position for right hand servo
    angle2 = 90  # Default position for left hand servo
    ...
    if result.multi_hand_landmarks:
        for hand_landmarks, handedness in zip(result.multi_hand_landmarks, result.multi_handedness):
            ...
            # Draw landmarks and connection line
